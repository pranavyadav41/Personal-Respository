  ...
  import colorSharpImg from '../assets/img/color-sharp.png';
    ...
    return (
      <section className="skill py-16 relative" id="skills">
        <div className="container mx-auto flex justify-center">
          <div className="skill-bx bg-[#151515] rounded-[64px] text-center px-12 py-16 -mt-32 w-[80%] z-20">
        ...
        <img
          className="background-image absolute top-1/4 left-0 bottom-0 w-2/5"
          src={colorSharpImg}
          alt="Image"
        />
      </section>
